...
/**
 * 	\defgroup   rhum     Module Rhum
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/rhum/core/modules directory.
 *  \file       htdocs/rhum/core/modules/modRhum.class.php
 *  \ingroup    rhum
 *  \brief      Description and activation file for module Rhum
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module Rhum
 */
class modRhum extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->numero = 104666; // 104000 to 104999 for ATM CONSULTING
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'rhum';
		...
		$this->picto='rhum@rhum';

		// Defined all module parts (triggers, login, substitutions, menus, css, etc...)
		// for default path (eg: /rhum/core/xxxxx) (0=disable, 1=enable)
		// for specific path of parts (eg: /rhum/core/modules/barcode)
		// for specific css file (eg: /rhum/css/rhum.css.php)
		...
		//							'css' => array('/rhum/css/rhum.css.php'),	// Set this to relative path of css file if module has its own css file
	 	//							'js' => array('/rhum/js/rhum.js'),          // Set this to relative path of js file if module must load a js on all pages
		//							'hooks' => array('hookcontext1','hookcontext2')  	// Set here all hooks context managed by module
		//							'dir' => array('output' => 'othermodulename'),      // To force the default directories names
		//							'workflow' => array('WORKFLOW_MODULE1_YOURACTIONTYPE_MODULE2'=>array('enabled'=>'! empty($conf->module1->enabled) && ! empty($conf->module2->enabled)', 'picto'=>'yourpicto@rhum')) // Set here all workflow context managed by module
		//                        );
		$this->module_parts = array(
				'triggers' => 1,
				'hooks' => array('thirdpartycard', 'productcard', 'ordercard')
		);

		// Data directories to create when module is enabled.
		// Example: this->dirs = array("/rhum/temp");
		$this->dirs = array();

		// Config pages. Put here list of php page, stored into rhum/admin directory, to use to setup module.
		$this->config_page_url = array("rhum_setup.php@rhum");
		...
		$this->langfiles = array("rhum@rhum");
        ...
        //                              'objecttype:+tabname2:Title2:rhum@rhum:$user->rights->othermodule->read:/rhum/mynewtab2.php?id=__ID__',  	// To add another new tab identified by code tabname2
        ...
        {
        	$conf->rhum=new stdClass();
        	$conf->rhum->enabled=0;
        }
		$this->dictionaries=array();
        /* Example:
        if (! isset($conf->rhum->enabled)) $conf->rhum->enabled=0;	// This is to avoid warnings
        $this->dictionaries=array(
            'langs'=>'rhum@rhum',
            ...
            'tabcond'=>array($conf->rhum->enabled,$conf->rhum->enabled,$conf->rhum->enabled)												// Condition to show each dictionary
        );
        */
...
*/		 
		...
		$this->menu[$r]=array(	
			...
			'type'=>'top',			                // This is a Top menu entry
			'titre'=>$langs->trans('TopMenuRhum'),
			'mainmenu'=>'rhum',
			'leftmenu'=>'',
			'url'=>'/rhum/list.php',
			'langs'=>'rhum@rhum',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=>'$conf->rhum->enabled',	// Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled.
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=rhum',			                // Put 0 if this is a top menu
